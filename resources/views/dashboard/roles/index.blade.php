                  ...
                  <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                      <li class="breadcrumb-item active" aria-current="page">
                        <a href="{{ route('roles.create') }}" class="btn btn-outline-primary modify-btn" title="Add Role">
                        ...
                        <tbody>
                          ...
                          @foreach($roles as $role)
                            <tr>
                              ...
                              <td>{{ $role->name }}</td>
                              <td>
                                <a href="{{ route('roles.edit',$role->id) }}" class="edit-delete edit"> <i class="fa fa-pencil-square-o" aria-hidden="true" title="edit"></i> </a>
